class ChatRoom < ApplicationRecord
    ...
    after_commit :destroy_room_notification, on: :destroy
    after_commit :update_room_notification, on: :update
    ...
    def destroy_room_notification
        Pusher.trigger('chat_room','destroy',self.as_json)
    end
    
    def update_room_notification
